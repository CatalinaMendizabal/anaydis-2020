...
public class RandomizedTreeMap<K,V> implements Map<K,V> {
    ...
    private int size;
    private final double rootInsertionProbability;

    public RandomizedTreeMap(Comparator<K> comparator) {
        this.head = null;
        this.comparator = comparator;
        rootInsertionProbability = 0.5;
    }

    public RandomizedTreeMap(Comparator<K> comparator, double n) {
        this.head = null;
        this.comparator = comparator;
        rootInsertionProbability = 1/(1 + n);
    }
